  ...
  return (
    <div className="min-h-screen bg-[#080808] text-white font-mono flex flex-col">
      <header className="h-16 border-b border-white/[0.06] flex items-center px-8">
        <span className="text-[9px] tracking-[0.45em] uppercase text-white/20">Profile Settings</span>
      </header>
      ...
      <div className="max-w-md w-full mx-auto px-8 py-12 flex flex-col gap-px">
        ...
        <div className="border border-white/[0.06] p-8 flex flex-col items-center gap-4">
          <div className="relative group">
            <div className="w-20 h-20 border border-white/15 bg-white/[0.03] flex items-center justify-center text-xl font-light text-white/50 overflow-hidden">
              {avatar ? <img src={avatar} className="w-full h-full object-cover" /> : "JD"}
            </div>
          ...
          <span className="text-[9px] tracking-[0.3em] uppercase text-white/20">Click to upload</span>
        </div>

        {/* Name */}
        <div className="border border-white/[0.06] p-6 flex flex-col gap-3">
          <label className="text-[9px] tracking-[0.4em] uppercase text-white/20">Display Name</label>
          <input
            value={name}
        ...
        {/* Email */}
        <div className="border border-white/[0.06] p-6 flex flex-col gap-3">
          <label className="text-[9px] tracking-[0.4em] uppercase text-white/20">Email Address</label>
          <input
            value={email}
        ...
        {/* Password */}
        <div className="border border-white/[0.06] p-6 flex flex-col gap-3">
          <label className="text-[9px] tracking-[0.4em] uppercase text-white/20">New Password</label>
